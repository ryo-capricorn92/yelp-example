...
$.ajax({
  url: "https://thingproxy.freeboard.io/fetch/https://api.yelp.com/oauth2/token",
  method: "POST",
  data: {
    client_id: clientId,
...
//   },
//   url: "https://thingproxy.freeboard.io/fetch/https://api.yelp.com/v3/businesses/search?term=" + searchTerm + "&location=" + "Raleigh",
//   method: "GET"
// }).done(function (response) {
